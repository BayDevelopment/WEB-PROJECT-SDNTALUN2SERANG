...
<style>
    ...
    .profile-hero .cover {
        height: 110px;
        background: radial-gradient(1200px 200px at -10% -50%, rgba(99, 102, 241, .15) 0, transparent 60%),
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <div>
            ...
            <ol class="breadcrumb breadcrumb-modern mb-0">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('guru/data-siswa') ?>">Data Siswa</a></li>
                <li class="breadcrumb-item active">Detail</li>
            </ol>
        </div>

        <div class="no-print mt-3 mt-sm-0 d-flex gap-2">
            <a href="<?= base_url('guru/data-siswa') ?>" class="btn btn-dark rounded-pill">
            ...
            <div class="profile-hero mb-3">
                ...
                <div class="body">
                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-3">
                        <img
                            src="<?= !empty($siswa['photo']) ? base_url('assets/img/uploads/' . esc($siswa['photo'], 'attr')) : base_url('assets/img/user.png') ?>"
