...
<div class="container-fluid px-4 page-section">
    ...
    <div class="d-sm-flex align-items-center justify-content-between gap-2 gap-sm-3 mb-3 flex-wrap">
        <div class="order-2 order-sm-1">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-modern mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?= base_url('operator/laporan/nilai-siswa') ?>">Nilai Siswa</a>
                    </li>
        ...
        <div class="order-1 order-sm-2 d-flex align-items-center">
            <a href="<?= base_url('operator/kategori/tambah') ?>"
                class="btn btn-success btn-sm rounded-pill py-2">
            ...
            <form id="formTambahNilai"
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select
                            class="form-select<?= $hasErr('mapel_id') ? ' is-invalid' : '' ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if (empty($optKategori)): ?>
                            <!-- Saat tidak ada data kategori -->
                            <div class="alert alert-warning py-2 mb-2">
                                <i class="fa-solid fa-triangle-exclamation me-2"></i>
                                <strong>Tidak ada kategori saat ini</strong>, silahkan isi terlebih dahulu.
                            </div>

                            <!-- Select dummy yang dinonaktifkan (agar UI konsisten) -->
                            <select class="form-select" id="kategori_id" name="kategori_id" disabled>
                                <option value="">— Kategori belum tersedia —</option>
                            </select>

                            <!-- Jika pakai validasi server, jangan pakai required saat kosong -->
                            <?php if ($hasErr('kategori_id')): ?>
                                <div id="katFeedback" class="invalid-feedback d-block"><?= esc($getErr('kategori_id')) ?></div>
                            <?php endif; ?>

                            <!-- (Opsional) matikan tombol submit di halaman ini -->
                            <script>
                        ...
                        <?php else: ?>
                            <!-- Saat ada data kategori -->
                            <select
                                class="form-select<?= $hasErr('kategori_id') ? ' is-invalid' : '' ?>"
                                ...
                                <?php foreach ($optKategori as $k): ?>
                                    <?php
                                    // Auto-preselect via ?kategori=UTS/UAS kalau old() kosong
                                    $preSelect = '';
                ...
                <div class="d-flex gap-2 mt-4">
                    ...
                    <a href="<?= base_url('operator/nilai-siswa') ?>" class="btn btn-dark rounded-pill">
