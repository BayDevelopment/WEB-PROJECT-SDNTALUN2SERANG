    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <div>
            ...
            <ol class="breadcrumb breadcrumb-modern mb-0">
                ...
                <li class="breadcrumb-item active"><?= esc($sub_judul ?? 'Edit Kelas') ?></li>
            </ol>
        </div>
    </div>
    ...
    <div class="card card-elevated mb-3">
        <div class="card-header-modern">
            <div class="title-wrap">
                <i class="fa-solid fa-school me-2"></i> Form Edit Kelas
            </div>
        </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select<?= $hasErr('tingkat') ? ' is-invalid' : '' ?>"
                            ...
                            <option value="" disabled <?= $valTingkat === '' ? 'selected' : '' ?>>— Pilih Tingkat —</option>
                            <?php foreach (['1', '2', '3', '4', '5', '6'] as $t): ?>
                                <option value="<?= $t ?>" <?= $valTingkat === $t ? 'selected' : '' ?>><?= $t ?></option>
                            <?php endforeach; ?>
                        </select>
                        ...
                        <?php endif; ?>
                        <div class="form-text">Sesuaikan opsi bila jenjang berbeda.</div>
                    </div>
