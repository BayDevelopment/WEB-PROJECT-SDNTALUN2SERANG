...
<style>
    ...
    /* ===== Card Modern (gradient border subtle) ===== */
    .card-modern {
        position: relative;
        border-radius: 18px;
        background: #fff;
...
<div class="container-fluid px-4 fade-in-up delay-300">
    ...
    <div class="row g-3 g-md-4 mb-3">
        ...
        <div class="col-lg-4">
            <div class="card-modern">
                <div class="card-header">
                    <i class="fa-regular fa-id-card text-primary"></i> Profil Siswa
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-8">
            ...
            <div class="card-modern">
                <div class="card-header">
                    <i class="fas fa-chart-bar text-primary me-2"></i> Nilai per Mapel
                </div>
                <div class="card-body">
