...
<body>
                ...
                <div class="col-sm-10 col-md-7 col-lg-5">
                    <div class="card card-login rounded-4">
                        <div class="card-header-modern">
                            ...
                            <p class="text-center">Silahkan login dengan akun yang sudah disiapkan!</p>
                        </div>
                        ...
                        <div class="card-body p-4 p-lg-4">
                            <form action="<?= base_url('auth/login') ?>" method="post" novalidate>
                                ...
                                <div class="form-floating mb-3 position-relative">
                                    ...
                                    <span class="input-icon" id="togglePass" aria-label="Show/Hide password">
    ...
    <script>
        // Inisialisasi particles.js (tema biru–putih)
